...
class GoogleDriveHelper:
    ...
    def drive_list(self, file_name):
        ...
        for parent_id in DRIVE_ID:
            ...
            if response:
                for file in response:
                    ...
                    if add_title_msg:
                        msg = f'<h3>Here Are Your Results For: {file_name}</h3><br><b><a href="https://github.com/mhjoy99' \
                              f'/MHJoySearchBot"> Bot Repo </a></b> || @mhjoybots '
                        add_title_msg = False
                    if add_drive_title:
        ...
        for content in self.telegraph_content:
            self.path.append(
                telegraph_obj.create_page(title=f'{pref} MHJoyBotsSearch', html_content=content)['path'])
